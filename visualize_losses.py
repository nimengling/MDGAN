...
parser.add_argument('--path', type=str, default='checkpoints/shayan_80/2022_08_02_12_37_08_batch_size:3_loss_mode:bce_lr_g_0.0004_lr_d_0.0004_EMA_decay_0.8/losses')
...
for item in exp_list:
    ...
    x = np.linspace(0, args.step_x * len(cur_plot["total"]), len(cur_plot["total"]))
    plt.plot(x, cur_plot["total"], label=loss)
